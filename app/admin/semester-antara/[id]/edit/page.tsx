...
export default function EditSemesterAntaraPage() {
  ...
  useEffect(() => {
    // TODO: Fetch data semester antara berdasarkan ID
    const fetchData = async () => {
      try {
        ...
        // const response = await fetch(`/api/semester-antara/${id}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: Implementasi logika update ke database
      console.log('Update semester antara:', id, formData);
      
      // Simulasi update
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Redirect ke halaman list setelah berhasil
      router.push('/admin/semester-antara');
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Edit Semester Antara</h1>
        <p className="mt-1 text-sm text-gray-600">
          Edit informasi semester antara
        </p>
      </div>
