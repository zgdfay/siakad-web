...
export function HeroSection() {
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-primary/5 via-background to-primary/5 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        {/* Hero Content */}
        <div className="max-w-4xl mx-auto text-center space-y-8 mb-16">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight">
            Meningkatkan efisiensi dalam semua aspek{' '}
            <span className="text-primary">administrasi akademik</span>
          </h1>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Dorong batas inovasi dan optimasi dengan platform kami. Unggul dalam
            operasi Anda dan berikan nilai luar biasa kepada mahasiswa.
          </p>
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="relative rounded-2xl border border-border/50 bg-white shadow-2xl overflow-hidden">
            ...
            <div className="relative w-full aspect-video">
              <Image
                src="/hero-landing/hero-landing.png"
